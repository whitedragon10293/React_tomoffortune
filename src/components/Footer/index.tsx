...
const Footer = () => {
  return (
    <footer className="container flex justify-end w-full absolute bottom-0 p-4 z-10">
      <button
        className="bg-twitter-btn-bg hover:bg-twitter-btn-bg-hover bg-contain w-16 h-16"
        onClick={() => window.open("https://twitter.com/TombsOfFortune")}
      />
      <button
        className="bg-discord-btn-bg hover:bg-discord-btn-bg-hover bg-contain w-16 h-16 ml-5"
